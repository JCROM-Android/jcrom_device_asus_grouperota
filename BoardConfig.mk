...
TARGET_BOARD_INFO_FILE := device/asus/grouperota/board-info.txt
...
BOARD_EGL_CFG := device/asus/grouperota/egl.cfg
...
TARGET_RELEASETOOLS_EXTENSIONS := device/asus/grouperota
